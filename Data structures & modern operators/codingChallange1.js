...
// player1 & player2 for each team 
// here we can use destructuring
...
function printGoals(...numberOfPlayers){
    ...
    return console.log(`scored goals are : ${totalGoals}`)  
}
...
printGoals(...game.scored)  // this passes the parameters in seperate values i.e. rest values one by one
